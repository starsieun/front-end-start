    ...
    var todayPhoto = [    
        ...
        ,{"url":"http://sports.media.daum.net/general/galㄱ;ㅔ0ery/gagsports/index.html","img":"http://icon.daumcdn.net/w/c/12/05/81730673405131839.jpeg","title":"&#39;내가 더 잘해&#39; 후보GK 경기 난입해 선방","id":"20120516100608409"}
    ...
    function btn_front(){
        ...
        if(currentImage==1)
        {
            ...
            for(var i=currentImage-1; i<=currentImage+1; i++)
            {
